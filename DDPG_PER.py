...
class DDPG() :
	"""
	Deep Deterministic Policy Gradient algorithm with Prioritized Experience Replay.
	...
	alpha_sampling : float, optional, default: 1
		Exponent interpolating between a uniform sampling (0) and
		a greedy prioritization (1).
	beta_IS : float, optional, default: 1
		Exponent of the importance-sampling weights.
		If 0, the importance sampling is disabled.
