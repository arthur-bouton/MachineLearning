...
- ***looptools.py***: Tools to monitor and have control during algorithm progress loops. Contains a context manager which allows the SIGINT signal to be processed asynchronously and a class to plot variables incrementally on a persistent figure.
